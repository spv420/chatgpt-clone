...
router.post('/', async (req, res) => {
  ...
  if (endpoint !== 'vicuna') return handleError(res, { text: 'Illegal request' });
...
//            sender: endpointOption?.jailbreak ? 'Sydney' : 'BingAI',
    ...
    let conversationUpdate = { conversationId: newConversationId, endpoint: 'vicuna' };
